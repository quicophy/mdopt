...
exclude_patterns = [
    ...
    "Thumbs.db",
    ".DS_Store",
    # Use docs/source/api/* as canonical API docs generated by sphinx-apidoc.
    # These legacy root-level files duplicate object declarations.
    "modules.rst",
    "mdopt.rst",
    "mdopt.contractor.rst",
    "mdopt.mps.rst",
    "mdopt.optimiser.rst",
    "mdopt.utils.rst",
]
...
def add_line_no_object_base(self, text, *args, **kwargs):
    # Avoid relying on Sphinx internals that changed across versions.
    if text.strip() == "Bases: :py:class:`object`":
        return
