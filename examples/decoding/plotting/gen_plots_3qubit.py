...
fig.savefig(_fig("heatmaps_3qubit.pdf"), dpi=300, bbox_inches="tight")
print("Saved heatmaps_3qubit.pdf")
...
fig.savefig(_fig("truncation_error_3qubit.pdf"), dpi=300, bbox_inches="tight")
print("Saved truncation_error_3qubit.pdf")
...
axes[1].legend()
fig.savefig(_fig("logical_probs_3qubit.pdf"), dpi=300, bbox_inches="tight")
print("Saved logical_probs_3qubit.pdf")
